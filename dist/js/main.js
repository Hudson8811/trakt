...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
  ...
  if (dwidth !== wwidth) {
    ...
    tl1.clear();
    tl2.clear();
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(".loader__center, .loader__logo, .loader__title, .loader .l1, .loader .l2, .loader .l3, .loader .l4,.loader," + ".c1__title,.c1__contacts,.first,.contacts-page__walk,.contacts-page__startWalk," + ".contacts-page__map" + ".contacts-page", {
      clearProps: "all"
    });
    window.scrollTo({
      top: 0,
...
function initScrollAnimationDesktop() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gp-how-item').each(function () {
    ...
    if (img2.length > 0) tl1.from(img2, {
      width: "200%",
      height: "200%",
      duration: 5,
      ease: "power1.out"
...
var st1;
var tl1 = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({});
var greenHeigh, greenContentHeigh;
var scrollHeight, scrollContentHeight;
var resizeFunction;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {
  resizeFunction();
});
function initAnimation() {
  greenHeigh = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pp-green').innerHeight();
  greenContentHeigh = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pp-green__inner').innerHeight();
  scrollHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.project-scroll').innerHeight();
  scrollContentHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.project-static').innerHeight();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
  ...
  if (dwidth !== wwidth) {
    ...
    if (typeof st1 !== "undefined") st1.kill();
    tl1.clear();
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(".project-page," + ".at1,.at2,.at3,.at4,.pp-intro__text,.as1,.as2,.as3,.as4,.pp-image,.pp-task,.pp-task__img,.pp-task__img img," + ".pp-task__text,.pp-task__content,.pp-green,.pp-green__title,.pp-green__text,.pp-green__blocks," + ".pp-green__inner,.project-scroll,.project-static, .pp-image img", {
      clearProps: "all"
    });
    window.scrollTo({
      top: 0,
...
function initScrollAnimationTablet() {
  resizeFunction = function resizeFunction() {
    var listElems = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pp-task__img img, .pp-image img');
    var windowHalf = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height() * 0.5;
    var viewportBottom = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() + jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
    var viewportCenter = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() + jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height() * 0.35;
    listElems.each(function () {
    ...
    var greenBlockTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pp-green').offset().top;
    var greenBlockTop2 = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pp-green').innerHeight();
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() >= greenBlockTop && !lightHead && jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() <= greenBlockTop + greenBlockTop2 && !lightHead) {
      (0,_functions__WEBPACK_IMPORTED_MODULE_4__.setMaskHeader)(0);
      lightHead = true;
    } else if (greenBlockTop >= jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() && greenBlockTop <= viewportBottom && lightHead) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-hide-menu,.menu__overlay').on('click', function (event) {
    event.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-show-menu').on('click', function (event) {
    event.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu').addClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.to-top', function (event) {
    event.preventDefault();
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-lk-page').length > 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-popup-avatar').on('click', function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
      var disabled = false;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-data-editing').click(function () {
        if (disabled) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.input-text').prop('disabled', true);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-lk-page__order').addClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-lk-page__save').removeClass('active');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.input-text').prop('disabled', false);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-lk-page__order').removeClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-lk-page__save').addClass('active');
        }
        disabled = !disabled;
      });
    });
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.register-lk-page').length > 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.register-lk-page__submit').on('click', function (e) {
      e.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.register-lk-page__response').addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.register-lk-page__tabs').removeClass('active');
  ...
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.catalog-inside-lk-page').length > 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".selector").selectmenu();
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cart-product-page').length > 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider-big').slick({
      lazyLoad: 'ondemand',
      fade: true,
      speed: 500,
      slidesToShow: 1,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu-lk__btn').on('click', function () {
...
/***/ "./src/js/import/jquery-ui.js":
/*!************************************!*\
  !*** ./src/js/import/jquery-ui.js ***!
  \************************************/
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(obj){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(obj){return typeof obj;}:function(obj){return obj&&"function"==typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;},_typeof(obj);}/*! jQuery UI - v1.13.2 - 2023-02-06
* http://jqueryui.com
...
/* harmony import */ var _import_jquery_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/jquery-ui */ "./src/js/import/jquery-ui.js");
/* harmony import */ var _import_jquery_ui__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_jquery_ui__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _import_slick_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./import/slick.min */ "./src/js/import/slick.min.js");
/* harmony import */ var _import_slick_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_import_slick_min__WEBPACK_IMPORTED_MODULE_3__);
